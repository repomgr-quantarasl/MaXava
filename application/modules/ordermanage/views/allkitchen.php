			...
			$k=0;
                ...
                <div class="panel-body">
                    ...
                    <div class="grid-sizer col-vxs-12 col-xs-6 col-md-4 col-lg-3 col-xlg-4"></div>
					    <?php if(!empty($kitchenorderinfo) && isset($kitchenorderinfo['orderlist']) && !empty($kitchenorderinfo['orderlist'])){
							$t=0;
						...
						if( strpos($allchecked2, '0') !== false ) {
							...
							?>
								...
								// Show "no orders found" when kitchen has no orders or orderlist is empty
