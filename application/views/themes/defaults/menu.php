        ...
        <div class="row">
            <div class="col-xl-3 col-md-4 sidebar leftSidebar">
                <?php echo form_open('menu','method="post" class="form-inline mb-3"')?>
                    <input type="text" class="form-control productSelection" autocomplete="off" onfocus="producstList();" oninput="producstList();" name="product_name" id="product_name" placeholder="<?php echo display('search') ?>" aria-required="true"> <input class="autocomplete_hidden_value" name="product_id" id="SchoolHiddenId" type="hidden">
