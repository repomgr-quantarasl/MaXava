<div class="form-group text-right">
    ...
    <button type="button" class="btn btn-primary btn-md" data-target="#add0" data-toggle="modal">
        ...
        <?php echo display('add_salary_setup') ?>
    </button>
    <?php endif; ?>

    <?php if ($this->permission->method('hrm', 'read')->access()) : ?>
    <a href="<?php echo base_url(); ?>hrm/Payroll/salary_setup_view" class="btn btn-primary">
                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="panel">
                            <div class="panel-body">
                                ...
                                <!-- Salary Type -->
                                <div class="form-group row">
                                    <label for="sal_type_name" class="col-sm-3 col-form-label">
                                        <?php echo display('salary_type_id') ?> *
                                    </label>
                                    <div class="col-sm-9">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 text-center">
                                        <h4 class="salary-setup-form-css1"><?php echo display('addition') ?></h4>
                                        <br>
                                        <table id="add" class="table table-bordered">
                                            <tr>
                                                <th><?php echo display('basic') ?></th>
                                                <td>
                                                    <input type="text" id="basic" name="basic" class="form-control" readonly>
                                                </td>
                                            </tr>
                                            <?php
                                            $x = 0;
                                            ...
                                            ?>
                                            <tr>
                                                <th><?php echo $ab->sal_name; ?></th>
                                                <td>
                                                    <input type="number" name="amount[<?php echo $ab->salary_type_id; ?>]"
                                    ...
                                    <!-- Deductions -->
                                    <div class="col-sm-6 text-center">
                                        <h4 class="salary-setup-form-css2"><?php echo display('deduction') ?></h4>
                                        <br>
                                        <table id="dduct" class="table table-bordered">
                                            <?php
                                            $y = 0;
                                            foreach ($sldname as $row) {
                                            ?>
                                            <tr>
                                                <th><?php echo $row->sal_name; ?></th>
                                                <td>
                                                    <input type="number" name="amount[<?php echo $row->salary_type_id; ?>]"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" name="tax" id="taxinput"
                                                        class="form-control" onkeyup="summary()">
                                                </td>
                                                <td>
                                ...
                                <!-- Gross Salary -->
                                <div class="form-group row">
                                    <label for="grsalary" class="col-sm-3 col-form-label text-center">
                                        <?php echo display('gross_salary') ?>
                                    </label>
                                    <div class="col-sm-9">
