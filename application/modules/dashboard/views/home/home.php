...
<div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2">
                <div class="panel home-panel-bd bg-gradient-custom-indigo d-flex align-items-center justify-content-center">
                    <div class="panel-body">
                        <div class="statistic-box text-center text-white">
                            <h2><span class="count-number"><?php echo $lifetime_orders_total; ?></span> <span class="slight"> </span></h2>
                            <div class="lifeord"><?php echo display('pending_ord')?></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2">
                <div class="panel home-panel-bd bg-gradient-custom-orange d-flex align-items-center justify-content-center">
                    <div class="panel-body">
                        <div class="statistic-box text-center text-white">
                            <h2><span class="count-number"><?php echo $today_customers_total; ?></span> <span class="slight"> </span></h2>
                            <div class="lifeord"><?php echo display('todaycustomersdash')?></div>
                        </div>
                    </div>
                </div>
            </div>
