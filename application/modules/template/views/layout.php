...
// Safety check for title variable
if (!isset($title)) {
    $title = '';
}
?>
                ...
                <section class="content-header">
                    ...
                    <div class="header-title">
                        <h1><?php if($this->uri->segment(2)=="paymentmethod"){
                                    ...
                                    $titlename=display('shippingmethod');
									}
                                    ...
                                    $titlename=display('restauranttable');
									}
                                    ...
                                    else if($this->uri->segment(2)=="reports"){
                                        $titlename=display('reports');
                                        }
                                        else if($this->uri->segment(2)=="purchase"){
                                        $titlename=display('purchase');
                                        }
                                        else if($this->uri->segment(2)=="home"){
                                            $titlename=display('home');
                                            }
								else{
