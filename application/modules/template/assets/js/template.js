...
// Initialize prevsltab to prevent undefined errors
window.prevsltab = null;
...
$(document).on('click', '#cancelreason', function(){ 
				...
				$.ajax({
						...
						success: function(data){
							...
							// Check if prevsltab exists and is a valid jQuery object before triggering click
							if (window.prevsltab && typeof window.prevsltab.trigger === 'function') {
								window.prevsltab.trigger('click');
							}
