       ...
       ?>
                  ...
                  <div class="col-md-8 row ">
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="mpesa-area w-100 no-gutters display-none">
                        <div class="form-group col-md-6">
                            <label for="mpesa_number" class="col-form-label">M-Pesa Mobile Number</label>
                           
                                  <input type="text" class="form-control" name="mpesa_number[]" id="mpesa_number" placeholder="254712345678" />
