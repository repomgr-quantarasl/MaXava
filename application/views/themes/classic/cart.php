                            ...
                            <div class="shipping_part shipping_custom mt-5">
                                ...
                                <div class="radios shipping_custom_box" id="payment">
                                    <?php foreach($shippinginfo as $shipment){ 
                                        // $display_rate = '';
                                        // if($shipment->rate_type == 'amount'){
                                        //     // Display as currency
                                        //     if($this->storecurrency->position == 1){
                                        //         $display_rate = $this->storecurrency->curr_icon . number_format($shipment->shippingrate,2);
                                        //     } else {
                                        //         $display_rate = number_format($shipment->shippingrate,2) . $this->storecurrency->curr_icon;
                                        //     }
                                        // } else if($shipment->rate_type == 'percentage'){
                                        //     // Display as percentage
                                        //     $display_rate = $shipment->shippingrate . '%';
                                        // }
                                    ?>
                                        <div class="radio">
                                            <input type="radio" 
                                                ...
                                                onchange="getcheckbox('<?php echo $shipment->shippingrate;?>','<?php echo $shipment->shipping_method;?>','<?php echo $shipment->rate_type;?>');">
                                            <label for="payment_method_cre<?php echo $shipment->ship_id;?>" class="shipping">
                                                <span class="checker"></span>
                                                <?php echo $shipment->shipping_method;?>  <?php echo $display_rate; ?>
                                            </label>
                                        </div>
                                    <?php } ?>
                                </div>
