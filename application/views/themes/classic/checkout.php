            ...
            <?php echo form_open('hungry/placeorder','method="post" class="row"')?>
                ...
                <div class="col-xl-4 col-lg-5 col-md-8">
                    <div class="check_order">
                        ...
                        <?php if (!empty($selected_shipping_method)): ?>
                        <div class="selected-shipping-method mt-3 mb-3">
                            <h6 class="mb-2">Selected Delivery Method</h6>
                            <div class="alert alert-info">
                                <strong><?php echo $selected_shipping_method->shipping_method; ?></strong>
                                <input type="hidden" id="selected-shipping-method" value="<?php echo $selected_shipping_method->shipping_method; ?>">
                            </div>
                        </div>
                        <?php endif; ?>
                        
                        <!-- Table Selection Section -->
                        <div class="table-selection-section mt-3" id="table-selection-container" style="display: none;">
                            <h6 class="mb-2">Table Selection</h6>
                            <div class="form-group">
                                <label class="control-label" for="tableid">Select Table <abbr class="required" title="required">*</abbr></label>
                                <select name="tableid" id="tableid" class="form-control" required>
                                    <?php 
                                    if(!empty($tables)) {
                                        foreach($tables as $key => $value) {
                                            $selected = '';
                                            if(isset($_SESSION['selected_table_id']) && $_SESSION['selected_table_id'] == $key) {
                                                $selected = 'selected';
                                            }
