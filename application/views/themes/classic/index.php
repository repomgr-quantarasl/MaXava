...
// Set default SEO info if not found
if (empty($seoinfo)) {
	$seoinfo = (object) array(
		'title' => isset($title) ? $title : 'Default Title',
		'description' => 'Welcome to our restaurant - Best food delivery service',
...
<head>
	...
	<link href="<?php echo base_url(); ?>application/views/themes/<?php echo $acthemename; ?>/assets_web/plugins/lightslider-master/src/css/lightslider.css" rel="stylesheet">
	<link href="<?php echo base_url(); ?>application/views/themes/<?php echo $acthemename; ?>/assets_web/plugins/fancybox/src/css/core.css" rel="stylesheet">
	<link href="<?php echo base_url(); ?>application/views/themes/<?php echo $acthemename; ?>/assets_web/plugins/fancybox/src/css/fullscreen.css" rel="stylesheet">
	<link href="<?php echo base_url(); ?>application/views/themes/<?php echo $acthemename; ?>/assets_web/plugins/fancybox/src/css/thumbs.css" rel="stylesheet">
...
<body>
				...
				<nav id="sidebar" class="sidebar-nav">
					...
					<ul class="metismenu list-unstyled" id="mobile-menu">
						<?php foreach ($allmenu as $menu) {
							$mobile = ''; // Initialize mobile variable
							if ($menu->menu_name == 'Home') {
								$activeclass = 'active';
								$href = base_url() . $menu->menu_slug;
							} else {
	...
	<script src="<?php echo base_url(); ?>application/views/themes/<?php echo $acthemename; ?>/assets_web/plugins/lightslider-master/src/js/lightslider.js"></script>
	...
	<script src="<?php echo base_url(); ?>application/views/themes/<?php echo $acthemename; ?>/assets_web/plugins/fancybox/src/js/core.js"></script>
	<script src="<?php echo base_url(); ?>application/views/themes/<?php echo $acthemename; ?>/assets_web/plugins/fancybox/src/js/guestures.js"></script>
	<script src="<?php echo base_url(); ?>application/views/themes/<?php echo $acthemename; ?>/assets_web/plugins/fancybox/src/js/wheel.js"></script>
	<script src="<?php echo base_url(); ?>application/views/themes/<?php echo $acthemename; ?>/assets_web/plugins/fancybox/src/js/hash.js"></script>
	<script src="<?php echo base_url(); ?>application/views/themes/<?php echo $acthemename; ?>/assets_web/plugins/fancybox/src/js/thumbs.js"></script>
	...
	<script src="<?php echo base_url(); ?>application/views/themes/<?php echo $acthemename; ?>/assets_web/plugins/theia-sticky-sidebar/js/theia-sticky-sidebar.js"></script>
