...
<div class="user-panel d-flex align-items-center">
    <div class="image me-2">
        <?php $image = $this->session->userdata('image'); ?>
        <img src="<?php echo base_url(!empty($image) ? $image : 'assets/img/icons/default.jpg'); ?>" class="img-circle" alt="User Image" style="width:40px; height:40px;">
    </div>
    <div class="info">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="treeview <?php echo (($this->uri->segment(2)=="home" || $this->uri->segment(2)=="")?"active":null) ?>">
            <a href="<?php echo base_url('dashboard/home') ?>"><i class="fa ti-home"></i> <span><?php echo display('dashboard')?></span> 
            </a>
        </li>
