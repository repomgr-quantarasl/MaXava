...
class Home extends MX_Controller {
	...
	{   
		...
		$lifetimeOrdersTotal = $this->home_model->lifetime_orders_total();
		$lifetimeDishesTotal = $this->home_model->lifetime_dishes_total();
		$deliveredDishesTotal = $this->home_model->delivered_dishes_total();
		$pendingDishesTotal = $this->home_model->pending_dishes_total();
		$todayCustomersTotal = $this->home_model->today_customers_total();
		// Format amounts
		if($lifetimeOrdersTotal < 1000){
			$data["lifetime_orders_total"] = ($lifetimeOrdersTotal > 0 ? number_format($lifetimeOrdersTotal) : "0");
		}
		else{
			$data["lifetime_orders_total"] = $this->changeformat($lifetimeOrdersTotal);
		}
		$data["lifetime_dishes_total"] = $lifetimeDishesTotal;
		$data["delivered_dishes_total"] = $deliveredDishesTotal;
		$data["pending_dishes_total"] = $pendingDishesTotal;
		$data["today_customers_total"] = $todayCustomersTotal;
