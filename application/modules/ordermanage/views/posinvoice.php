...
.login-wrapper {
    background: url(../img/plateria/login-bg.jpg) no-repeat;
...
.food_item:focus .plateria_title,
.food_item:hover .plateria_title {
    color: #fff;
}
      ...
      <?php $i++;} }}?>
            ...
            <div class="invoice_address">
                ...
                <div class="text-center">
                    ...
                    <p class="b_top"><?php echo display('powerbyplateria')?></p>
                </div>
            </div>
        </div>
    </div>
