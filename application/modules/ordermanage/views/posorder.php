...
<?php 
// Safely check for updates with error handling
$new_version = 0; // Default value
$update_url = 'https://update.plateria.com/plateria/autoupdate/update_info';
...
// Use @ to suppress warnings and check if the request was successful
$update_response = @file_get_contents($update_url, false, $context);
if ($update_response !== false && !empty($update_response)) {
    $new_version = (int)$update_response;
}
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group row">
            ...
            <div class="col-sm-6">
              <input class="form-control simple-control" name ="customer_name" id="name" type="text" placeholder="Customer Name">
            </div>
          </div>
          <div class="form-group row">
                  ...
                  <div class="col-md-4">
                    <div class="leftSidebarPosMain">
                        ...
                        <div class="col-md-6 form-group">
                          ...
                          <div class="d-flex">
                            <?php $cusid=1;
                                                                    echo form_dropdown('customer_name',$customerlist,(!empty($cusid)?$cusid:null),'class="postform resizeselect form-control" id="customer_name"') ?>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                              ...
                              <?php $waiterkitchen=$this->session->userdata('id');
                                                                            echo form_dropdown('waiter',$waiterlist,(!empty($waiterkitchen)?$waiterkitchen:null),'class="form-control" id="waiter" ') ?>
                            </div>
                            <?php 
							if($possetting->tablemaping==1){
																		?>
                            <!-- Person button removed to eliminate highlighting -->
                            <input type="hidden" id="table_member" name="table_member" class="form-control" value="1" />
                            <?php } ?>
                            <div class="col-md-3 form-group" id="tblsec"> 
                           
                              <label for="store_id"><?php echo display('table');?> <span class="color-red"></span></label>
                              <?php echo form_dropdown('tableid',$tablelist,(!empty($tablelist->tableid)?$tablelist->tableid:null),'class="postform resizeselect form-control" id="tableid"  onchange="checktable()"')?>
